...
class TestDay01:
    ...
    def test_current_floor_examples(self, puzzle_input, expected_result):
    ...
    def test_position_character_taking_to_basement_examples(self, puzzle_input, expected_result):

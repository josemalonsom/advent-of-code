...
dimensions_boxes = input_file.readlines()
...
print("Total square feet of wrapping paper: " + str(total_square_feet_of_wrapping_paper))
print("Total ribbon length: " + str(total_ribbon_length))
